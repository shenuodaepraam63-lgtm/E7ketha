...
export const novelLinkTypeEnum = pgEnum('novel_link_type', ['read', 'download']);
...
export const novelLinks = pgTable('novelLinks', {
  id: serial('id').primaryKey(),
  novelId: integer('novelId').notNull(),
  label: varchar('label', { length: 120 }).notNull(),
  url: varchar('url', { length: 1000 }).notNull(),
  type: novelLinkTypeEnum('type').default('read').notNull(),
...
export type NovelLink = typeof novelLinks.$inferSelect;
