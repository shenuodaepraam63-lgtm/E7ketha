...
export function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="group inline-flex items-center gap-2.5" aria-label="رِواية — الصفحة الرئيسية">
      ...
      {!compact && <span className="text-[20px] font-extrabold tracking-[-.06em] text-[#111b42] dark:text-white">رِواية<span className="text-[#7067ef]">.</span></span>}
    </Link>
  );
}
